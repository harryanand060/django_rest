    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile', models.CharField(error_messages={'unique': 'A user with that mobile no already exists'}, help_text="Required. mobile number must be entered in the format: '+999999999'.", max_length=16, unique=True, validators=[common.core.validators.MobileValidator()], verbose_name='mobile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('unverified_mobile', models.CharField(error_messages={'unique': 'A user with that mobile no already exists.'}, help_text="Required. mobile number must be entered in the format: '+999999999'.", max_length=16, unique=True, validators=[common.core.validators.MobileValidator()], verbose_name='mobile')),
